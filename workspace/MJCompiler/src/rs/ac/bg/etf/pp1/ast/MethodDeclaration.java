...
public class MethodDeclaration extends MethodDeclPart {
    ...
    public MethodDeclaration (ReturnMethodType ReturnMethodType, FormPars FormPars, LocalVarDecl LocalVarDecl, StatementList StatementList) {
