...
public class ClassDeclLocalBody extends ClassDecl {

    private ClassName ClassName;
    private LocalVarDecl LocalVarDecl;
    private ClassBody ClassBody;

    public ClassDeclLocalBody (ClassName ClassName, LocalVarDecl LocalVarDecl, ClassBody ClassBody) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclLocalBody(\n");
