...
public class NoParametersMethod extends MethodDeclPart {

    private ReturnMethodType ReturnMethodType;
    private LocalVarDecl LocalVarDecl;
    private StatementList StatementList;

    public NoParametersMethod (ReturnMethodType ReturnMethodType, LocalVarDecl LocalVarDecl, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NoParametersMethod(\n");
